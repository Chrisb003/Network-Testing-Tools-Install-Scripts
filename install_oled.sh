...
# Ensure correct home directory even if run with sudo
if [ "$SUDO_USER" ]; then
...
echo "=================================================="
echo " OLED Monitor, PoE Fan & Captive Portal Manager"
echo "=================================================="
...
if [ $INSTALLED -eq 1 ]; then
    ...
    echo "1) Run Installation / Update"
